...
/**
 * slicc-migration/deploy/scripts/build-harness.mjs — build a local QA harness from a DA content page.
 *
 ...
 *
 * Usage: node slicc-migration/deploy/scripts/build-harness.mjs <contentFile> <outHarness> [--root <dir>]
 *   e.g. node slicc-migration/deploy/scripts/build-harness.mjs content/snowflake-blocks/test-12.html qa/test-12.html
...
if (!inFile || !outFile) {
  process.stderr.write('usage: node slicc-migration/deploy/scripts/build-harness.mjs <contentFile> <outHarness> [--root <dir>]\n');
  process.exit(1);
}
