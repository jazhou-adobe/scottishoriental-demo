 ...
 * slicc-migration/diff/scripts/content-inventory.mjs) plus the repeating-unit groups
 ...
 *
 * Usage:
 *   node slicc-migration/deploy/scripts/section-schema.mjs <prototypeURL> [options]
...
async function main() {
  ...
  if (!url) {
    process.stderr.write('usage: node slicc-migration/deploy/scripts/section-schema.mjs <prototypeURL> [--out file] [--width px] [--profile eds|generic]\n');
    process.exit(1);
  }
