 ...
 * (the SAME classifier as content-diff — slicc-migration/diff/scripts/content-inventory.mjs),
 ...
 *
 * Usage:
 *   node slicc-migration/deploy/scripts/block-roundtrip.mjs <prototypeURL> <content/page.html> [options]
...
async function main() {
  ...
  if (!proto || !content) {
    process.stderr.write('usage: node slicc-migration/deploy/scripts/block-roundtrip.mjs <prototypeURL> <content/page.html> [--blocks a,b] [--map name=sel] [--styles css] [--blocks-dir dir] [--width px] [--profile p] [--json]\n');
    process.exit(1);
  }
