...
```bash
node slicc-migration/rollout/scripts/section-fidelity.mjs \
...
```bash
node slicc-migration/rollout/scripts/media-reconcile.mjs --file <html> --deploy-host <host>   # all images
