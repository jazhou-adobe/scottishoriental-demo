 ...
 *
 * Reference: slicc-migration/migrate/reference/media-reconciliation.md and
 * slicc-migration/rollout/reference/delivery-gates.md § Gate 2.
 *
 * Usage:
 *   node slicc-migration/rollout/scripts/media-reconcile.mjs --file <html>
