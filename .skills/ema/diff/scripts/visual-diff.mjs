#!/usr/bin/env node
/**
 * slicc-migration/diff/scripts/visual-diff.mjs
 *
 ...
 *
 * Usage:
 *   node slicc-migration/diff/scripts/visual-diff.mjs <prototypeURL> <edsURL> [options]
...
const USAGE = `usage: node slicc-migration/diff/scripts/visual-diff.mjs <sourceURL> <buildURL> [options]
