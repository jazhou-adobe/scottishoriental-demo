#!/usr/bin/env node
/**
 * slicc-migration/diff/scripts/content-diff.mjs
 *
 ...
 *
 * Usage:
 *   node slicc-migration/diff/scripts/content-diff.mjs <prototypeURL> <edsURL> [options]
...
const USAGE = `usage: node slicc-migration/diff/scripts/content-diff.mjs <sourceURL> <buildURL> [options]
