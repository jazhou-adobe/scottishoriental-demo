/**
 * slicc-migration/diff/scripts/content-inventory.mjs
 *
 ...
 *   - slicc-migration/diff/scripts/content-diff.mjs          (post-deploy page probe, Step 10)
 *   - slicc-migration/deploy/scripts/section-schema.mjs      (pre-code ENCODE/DECODE contract, #93)
 *   - slicc-migration/deploy/scripts/block-roundtrip.mjs     (in-loop per-block gate, #94)
 *
