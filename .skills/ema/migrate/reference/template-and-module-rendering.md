...
- `slicc-migration/migrate/SKILL.md` — top-level migrate procedure
- `slicc-migration/migrate/reference/migration-procedure.md` — per-page
  procedure including idempotent skip and output-path mapping
- `slicc-migration/migrate/reference/metadata-and-jsonld.md` — head
  composition (orthogonal concern)
- `slicc-migration/migrate/reference/content-preservation.md` — content
...
- `slicc-migration/stardust/reference/data-attributes.md` — vocabulary
