...
- `slicc-migration/migrate/reference/template-and-module-rendering.md` —
...
- `slicc-migration/direct/SKILL.md` § Prep mode — where brand-level
  metadata is captured
- `slicc-migration/stardust/reference/state-machine.md` — `deployUrl`
