...
tooling — see
`slicc-migration/stardust/reference/migrate-output-format.md` for the
...
`slicc-migration/stardust/reference/migrate-output-format.md` § State.json
...
- `slicc-migration/migrate/reference/content-preservation.md` § Media
  references — the original content-preservation rules that this
  phase elaborates.
- `slicc-migration/migrate/reference/metadata-and-jsonld.md` § Favicon
